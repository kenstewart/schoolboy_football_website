...
?>
    ...
    <div id="column_container">
        <section class="left">
            <h1>Castleknock Under 13s Results</h1><br>

            <table width="100%" border="1" cellpadding="1" align="center">
                <?php
                $query = "SELECT date, home_team, home_team_score, status,away_team_score, away_team FROM 13results 
                      WHERE home_team = 'castleknock' OR away_team = 'castleknock'";
            ...
            <a href="index.php?action=castleknocku13">Back to Fixtures</a>
