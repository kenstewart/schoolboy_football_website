...
if ($submit != ''){
    ...
    if ($fixture = ''){
        ...
        $query = "SELECT date, home_team, away_team FROM 13fixtures WHERE id = '$fixture'";
            ...
            if ($count2 == 1){
                ...
                if ($count3 == 1){
                    ...
                    elseif ($home_team_score > $away_team_score){
                        $query6 = "UPDATE teams SET played = played + 1, won = won + 1, goals_for = goals_for + '$home_team_score', 
                                    goals_against = goals_against + '$away_team_score', goal_dif = goal_dif + '$home_team_score' - '$away_team_score', 
                                    points = points + 3 
                                    WHERE age = 'u13' AND team = '$home'";
