...
?>
    ...
    <div id="column_container">
        <section class="left">
            <h1>Castleknock Under 14s Fixtures</h1><br/>

            <table width="100%" border="1" cellpadding="1" align="center">
                <?php
                $query = "SELECT date, home_team, status, away_team FROM 14fixtures 
            ...
            <a href="index.php?action=castleknocku14results">View past Results</a>
